...
module.exports = {
    ...
    BOT_NAME: process.env.BOT_NAME || "SANNU-MD",
    DESCRIPTION: process.env.DESCRIPTION || "© 𝙿𝙾𝚆𝙴𝚁𝙳 𝙱𝚈🥷𝚂𝙰𝙽𝙽𝚄 𝙼𝙳 𝙼𝙸𝙽𝙸 𝙱𝙾𝚃",
    MODE: process.env.MODE || "public", // Options: public, private, inbox, group
    PUBLIC_MODE: process.env.PUBLIC_MODE || "true",
    
    // --- OWNER/DEV SETTINGS ---
    OWNER_NUMBER: process.env.OWNER_NUMBER || "94772563976",
    OWNER_NAME: process.env.OWNER_NAME || "Cʏʙᴇʀ Sᴀɴɴᴜ",
    DEV: process.env.DEV || "94772563976", // Developer number
    ...
    STICKER_NAME: process.env.STICKER_NAME || "Sᴀɴɴᴜ Mᴅ Mɪɴɪ Bᴏᴛ", // Sticker pack name
    MENU_IMAGE_URL: process.env.MENU_IMAGE_URL || "මෙනු ලොගො එක දන්න ඔනේ", // Menu image
    ALIVE_IMG: process.env.ALIVE_IMG || "ඇලො ලොගො එක දන්න ඔනේ", // Alive image
    LIVE_MSG: process.env.LIVE_MSG || ">SANNU MD  IS ALIVE😍", // Alive message
    ...
    AUTO_STATUS_REPLY: process.env.AUTO_STATUS_REPLY || "treu", // Auto reply on status (Enabled)
    AUTO_STATUS_MSG: process.env.AUTO_STATUS_MSG || ".𝚂𝙴𝙴𝙽 𝚈𝙾𝚄 𝚂𝚃𝙰𝚃𝚄𝚂 𝙱𝚈 © 🥷𝚂𝙰𝙽𝙽𝚄 𝙼𝙳 𝙼𝙸𝙽𝙸 𝙱𝙾𝚃", // Status reply message
    
    // --- GROUP & SECURITY ---
    ANTI_LINK: process.env.ANTI_LINK || "true",
    ANTI_LINK_KICK: process.env.ANTI_LINK_KICK || "false",
    DELETE_LINKS: process.env.DELETE_LINKS || "treu", // Automatic delete links without kick
